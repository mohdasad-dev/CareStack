    ...
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white rounded border text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        {appointments.map((item, index) => (
          <div className='flex flex-srap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] border items-center text-gray-500 py-3 px-6 hover:bg-gray-50' key={index}>
